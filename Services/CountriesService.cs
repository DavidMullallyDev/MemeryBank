...
namespace Services
{
    public class CountriesService : ICountriesService
    {
        ...
        public CountryResponse AddCountry(CountryAddRequest? countryAddRequest)
        {
            ...
            if (_db.Countries.Any((temp) => temp.CountryName == countryAddRequest.CountryName)) throw new ArgumentException($"Duplicate Country: {countryAddRequest.CountryName}");
        ...
        public CountryResponse? GetCountryByID(Guid? countryID)
        {
            ...
            Country? country = _db.Countries.FirstOrDefault(temp => temp.CountryId.Equals(countryID));
